...
export function getDatesBySearch(requestDate) {
    ...
    let year = dataNormal.getFullYear();
		...
		dateForRenderBySearch = `${dayForRender}/${monthForRender}/${year}`;
  }
  ...
  if (docs.length > 8) {
      ...
      markup += `<li class="list-news__item">
		...
		<div class="news-card__details">
			<span class="news-card__date">${dateForRenderBySearch}</span>
