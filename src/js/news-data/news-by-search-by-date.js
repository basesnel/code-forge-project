...
export async function getResponseForFilterByDate(response) {
    docs = response;
}

export async function getDates(requestDate) {

    for (date of requestDate) {
...
export async function getCalendarDate(currentDate) {
...
function renderMainNewsListDesctop() {
  ...
  <div class="news-card__details">
    <a class="news-card__date-link link" href="">${datesString[i]}</a>
