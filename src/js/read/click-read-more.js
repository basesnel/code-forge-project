import { save, load } from '../local-storage/locale-storage';
import { nowDataCreat } from '../calendar/now-data';
...
function addLiToArrayInLS(targetLi) {
  ...
  const data = {
    dataRead: nowDataCreat(),
    dataString: `<li class="list-news__item">${targetLi.innerHTML}</li>`,
    id: id,
  };
